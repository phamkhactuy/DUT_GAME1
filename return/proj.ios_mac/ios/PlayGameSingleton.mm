...
void PlayGameSingleton::shareOnTwitter(char* msg, char* url, char* image)
{
    ...
    NSString *strImgUrl = [NSString stringWithCString:image encoding:NSUTF8StringEncoding];
    if ([SLComposeViewController isAvailableForServiceType:SLServiceTypeTwitter])
    {
        SLComposeViewController *tweetSheet = [SLComposeViewController
                                               composeViewControllerForServiceType:SLServiceTypeTwitter];
        [tweetSheet setInitialText:strMessage];
        [tweetSheet setInitialText:strUrl];
        [tweetSheet addImage:[UIImage imageNamed:strImgUrl]];
        [appController.viewController presentViewController:tweetSheet animated:YES completion:nil];
    }
    else
    {
        UIAlertView *alerView = [[UIAlertView alloc] initWithTitle:@"Alert" message:@"You need login Tweetter" delegate:appController cancelButtonTitle:@"OK" otherButtonTitles:@"Settings", nil];
        [alerView show];
    }
...
void PlayGameSingleton::shareOnFacebook(char* msg, char* url, char* image)
{
    ...
    if([SLComposeViewController isAvailableForServiceType:SLServiceTypeFacebook]) {
        ...
        [controller setInitialText:strUrl];
        [controller addImage:[UIImage imageNamed:strImgUrl]];
        [appController.viewController presentViewController:controller animated:YES completion:Nil];
    }
    else
    {
        UIAlertView *alerView = [[UIAlertView alloc] initWithTitle:@"Alert" message:@"You need login Facebook" delegate:appController cancelButtonTitle:@"OK" otherButtonTitles:@"Settings", nil];
        [alerView show];
